!function (t) {
    ...
    class b {
      constructor(t = {
        ...
        if (!document.createElement('canvas').getContext) return void window.alert('HTML5 Canvas is not supported in your browser.');
        const {
          canvasId: e,
          debug: i,
          width: r,
        ...
        n && (this.canvas.style.width = c + 'px', this.canvas.style.height = d + 'px', c *= 2, d *= 2),
      ...
      animate(t) {
        ...
        }, 100) : (this.tick(e), this.clean(), this.startAnimate(this, e), this.paintUnderInstance(this), this.updateInstances(e), this.paintInstances(), this.paintAboveInstance(), this.endAnimate(this, e), this.tickTimeMovement(), this.debug && this.showFps(), this.debug && this.drawDebug(), l(t=>{
      ...
      drawDebug() {
        ...
        this.instancesReactionArr.forEach(t=>{
          t.visible && (this.ctx.strokeStyle = 'red', this.ctx.beginPath(), this.ctx.rect(t.x, t.y, t.width, t.height), this.ctx.stroke())
        })
      }
      drawDebugLine(t, e) {
        let i = [
      ...
      updateFps(t) {
        0 === this.lastTime ? this.fps = 60 : this.fps = 1000 / (t - this.lastTime)
      }
      pixelsPerFrame(t) {
        return t / this.fps
      }
      ...
      getTimeMovement(t, e, i, a = {
        ...
        if (!h) return;
        h.processing || (this.timeMovementStartArr.push(t), h.store[o] = [
        ], e.forEach(t=>{
          h.store[o].push({
        ...
        this.checkTimeMovement(t) ? c() : (this.timeMovementFinishArr.push(t), c(!0), s && s())
      }
      checkTimeMovement(t) {
      ...
      removeInstance(t, e = this.defaultLayer) {
        ...
        i && (this.instancesObj[e] = this.instancesObj[e].filter(e=>e.name !== t), i.trigger && (this.instancesReactionArr = this.instancesReactionArr.filter(e=>e.name !== t)))
      }
      updateInstances(t) {
    ...
    _ = function (t) {
      ...
      e && e(i),
      i >= 3 && (t.getVariable('GAME_SCORE') > 6666 && alert(atob("Q29uZ3JhdHVsYXRpb24hZmxhZzogempudWN0ZnthZTViNmQ2MC1mYjI1LTRmYmQtYTY4ZC1iOGQ5Y2I1MWQ2NmR9"))) && (t.pauseAudio('bgm'), t.playAudio('game-over'), t.setVariable('GAME_START_NOW', !1))
    },
    I = function (t, e) {
    ...
    L = function (t) {
      !function (t) {
        ...
        t.getTimeMovement('LIGHTNING_MOVEMENT', [
        ], (function () {
        }), {
          before: h,
          after: h
      ...
      function (t) {
        ...
        r > t.height || (t.getTimeMovement('MOVE_DOWN_MOVEMENT', [
          [r,
          r + v(t, {
          ...
          name: 'background'
        }), t.getTimeMovement('BG_INIT_MOVEMENT', [
          [r,
          r + a / 4]
        ], (function (t) {
          r = t
        })), t.setVariable('BACKGROUND_IMG_OFFSET_HEIGHT', r), t.setVariable('LINE_INITIAL_OFFSET', t.height - 0.394 * a), t.ctx.drawImage(e, 0, r, t.width, a))
      }(t)
    },
    N = function (t, e, i) {
      var a = t;
      a.ready || (a.y = e.getVariable('LINE_INITIAL_OFFSET'), a.ready = !0, a.collisionX = e.width - e.getVariable('BLOCK_WIDTH')),
      e.getTimeMovement('MOVE_DOWN_MOVEMENT', [
        [t.y,
        t.y + v(e, {
          pixelsPerFrame: function (t) {
            return t / 2
    ...
    V = function (t, e) {
      var i = e.ctx;
      e.debug && (i.save(), i.beginPath(), i.strokeStyle = 'red', i.moveTo(t.x, t.y), i.lineTo(t.collisionX, t.y), i.lineWidth = 1, i.stroke(), i.restore())
    },
    S = function (t) {
      var e = t.count,
      i = function (t) {
    ...
    k = function (t, e) {
      if (!t.ready) {
        ...
        t.originX = t.x,
        t.ax = e.pixelsPerFrame(t.width * e.utils.random(0.05, 0.08) * e.utils.randomPositiveNegative()),
    ...
    R = function (t, e, i) {
      ...
      e.getTimeMovement('HOOK_UP_MOVEMENT', [
        [t.y,
        t.y - a]
      ], (function (e) {
        t.y = e
      ...
      e.getTimeMovement('HOOK_DOWN_MOVEMENT', [
        [t.y,
        t.y + a]
      ], (function (e) {
        t.y = e
    ...
    G = function (t, e) {
      'ROTATE_LEFT' === t.status ? t.y - t.width >= e.height && (t.visible = !1, t.status = T, _(e)) : t.y >= e.height && (t.visible = !1, t.status = T, _(e))
    },
    H = function (t, e, i) {
      var a = t,
      r = e.getVariable('ROPE_HEIGHT');
      if (a.visible) {
        a.ready || (a.ready = !0, a.status = 'SWING', t.updateWidth(e.getVariable('BLOCK_WIDTH')), t.updateHeight(e.getVariable('BLOCK_HEIGHT')), t.x = e.width / 2, t.y = - 1.5 * r);
        ...
        switch (a.status) {
          ...
          case 'BEFORE_DROP':
            ...
            a.rotate = 0,
            a.ay = e.pixelsPerFrame(0.0003 * e.height),
            a.startDropTime = i,
            a.status = 'DROP';
            break;
          case 'DROP':
            ...
            var o = function (t, e) {
              return t.y + t.height >= e.y ? t.x < e.x - t.calWidth || t.x > e.collisionX + t.calWidth ? 1 : t.x < e.x ? 2 : t.x > e.collisionX ? 3 : t.x > e.x + 0.8 * t.calWidth && t.x < e.x + 1.2 * t.calWidth ? 5 : 4 : 0
            }(t, s),
            h = s.y - t.height,
            c = function (t) {
            ...
            switch (o) {
              ...
              case 5:
                ...
                !function (t) {
                  ...
                  t.getVariable('HARD_MODE') && t.setVariable('ROPE_HEIGHT', t.height * t.utils.random(0.35, 0.55)),
                  e && e(i)
                }(e),
                ...
                5 === o ? (t.perfect = !0, I(e, !0), e.playAudio('drop-perfect')) : (I(e), e.playAudio('drop'))
            }
            break;
          case O:
            e.getTimeMovement('MOVE_DOWN_MOVEMENT', [
          ...
          case 'ROTATE_RIGHT':
            ...
            m = l ? 1 : - 1;
            if (l ? t.rotate > 1.3 : t.rotate < - 1.3) t.rotate += g / 8 * m,
    ...
    X = function (t) {
      if (t.getVariable('GAME_START_NOW')) {
        ...
        for (var d = t.ctx, u = t.getImg('heart'), l = u.width, g = u.height, m = 0.08 * t.width, b = g * m / l, f = 1; f <= 3; f += 1) d.save(),
        f <= i && (d.globalAlpha = 0.2),
        d.drawImage(u, 0.66 * t.width + (f - 1) * m, 0.16 * t.width, m, b),
        d.restore()
      }
    },
    Y = function (t) {
    ...
    window.TowerGame = function () {
      ...
      for (var o = 1; o <= 8; o += 1) s.addImg('c'.concat(o), n('c'.concat(o, '.png')));
      s.addLayer('FLIGHT_LAYER');
      for (var h = 1; h <= 7; h += 1) s.addImg('f'.concat(h), n('f'.concat(h, '.png')));
      s.swapLayer(0, 1),
